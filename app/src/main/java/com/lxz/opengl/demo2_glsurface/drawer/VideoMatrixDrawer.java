...
public class VideoMatrixDrawer implements IDrawer {
    private static final String TAG = "VideoMatrixDrawer";
    // 顶点坐标
...
//    };
    ...
    private void initDefMatrix() {
        ...
        if (mVideoWidth != -1 && mVideoHeight != -1 && mWorldWidth != -1 && mWorldHeight != -1) {
            ...
            float originRatio = (float) mVideoWidth / (float)mVideoHeight;
            float worldRatio = (float)mWorldWidth / (float)mWorldHeight;
            Lg.d(TAG, "originRatio %f worldRatio %f", originRatio, worldRatio);
            if (originRatio > worldRatio) {
                ...
                Lg.d(TAG, "1 actualRatio " + actualRatio);
                ...
                Lg.d(TAG, "2 actualRatio " + actualRatio);
            }
        }
    }

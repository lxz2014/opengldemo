...
public class VideoSpiritLeftFilterDrawer implements IDrawer {
...
//    private int mVertexMatrixHandler = -1;
    ...
    public VideoSpiritLeftFilterDrawer() {
        // 【步骤1: 初始化顶点坐标】
    ...
    private String getVertexShader() {
        return ShaderUtils.getVertexshader("normal_filter");
    }

    private String getFragmentShader(){
        return ShaderUtils.getFragmentShader("spirit_left_filter");
    }
}

...
public class MediaEncoder {
    ...
    public MediaEncoder(int width, int height, int framerate, int keyColorFormat) {
        this(width, height, framerate, width * height * 3/*编码比特率*/, keyColorFormat);
    }

    @SuppressLint("NewApi")
    public MediaEncoder(int width, int height, int framerate, int bitrate, int keyColorFormat) {
        m_width = width;
        m_height = height;
